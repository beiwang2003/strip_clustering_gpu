...
static void findLeftRightBoundaryGPU(int nSeedStripsNC, int nStrips, float* clusterNoiseSquared_d, int *clusterLastIndexLeft_d, int *clusterLastIndexRight_d, int *seedStripsNCIndex_d, uint16_t *stripId_d, uint16_t *adc_d, float *noise_d)
{
   ...
   int index, testIndexLeft, testIndexRight;
   uint8_t testADC;
...
extern "C"
void  findClusterGPU(int nSeedStripsNC, int nStrips, float *clusterNoiseSquared_d, int *clusterLastIndexLeft_d,  int *clusterLastIndexRight_d, int *seedStripsNCIndex_d, uint16_t *stripId_d, uint16_t *adc_d, float *noise_d, float *gain_d, bool *trueCluster_d, uint8_t *clusterADCs_d)
{
  int nthreads = 256;
...
extern "C"
int setSeedStripsNCIndexGPU(int nStrips, uint16_t *stripId_d, uint16_t *adc_d, float *noise_d, int *seedStripsNCIndex_d){
  int nSeedStripsNC;
...
extern "C"
void cpyCPUToGPU(int nStrips, uint16_t *stripId_d, uint16_t *stripId, uint16_t *adc_d,  uint16_t *adc, float *noise_d, float *noise, float *gain_d, float *gain) {
