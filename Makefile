...
#git clone https://github.com/NVlabs/cub.git
	...
	GPUARCH=sm_60
	RMMROOT=/home/beiwang/.conda/envs/rmm_dev
endif 
...
ifeq ($(COMPILER), gnu)
	...
	CXXFLAGS += -std=c++17 -O3 -fopenmp -march=native \
	  ...
	  -I$(CUDA_PATH)/include -I$(RMMROOT)/include \
        -DUSE_GPU -DCACHE_ALLOC #-DRMM #-DNUMA_FT -DCALIB_1D #-DOUTPUT #-DACTIVE_STRIPS #-DCALIB_1D #-DOUTPUT -DCPU_DEBUG
...
ifeq ($(COMPILER), intel)
	...
	CXXFLAGS += -std=c++17 -O3 -qopenmp -xHost \
	  ...
	  -I$(CUDA_PATH)/include -I$(RMMROOT)/include -g \
...
NVCC = nvcc
CUDAFLAGS += -std=c++17 -O3 -g --default-stream per-thread -arch=$(GPUARCH) \
 -I$(RMMROOT)/include --ptxas-options=-v -lineinfo --maxrregcount 32\
 -DGPU_TIMER -DCACHE_ALLOC #-DRMM #-DCALIB_1D #-DCOPY_ADC #-DGPU_DEBUG #-DGPU_TIMER #-DCOPY_ADC #-DGPU_TIMER #-DGPU_DEBUG #-DCALIB_1D #-DGPU_TIMER #-DCALIB_1D -DCOPY_ADC #-DGPU_TIMER #-DUSE_TEXTURE -DGPU_DEBUG -DCUB_STDERR
